...
Detailed member descriptions: see the parse rules in parse_rules.cpp. every production rule introduces all of its components as child node pointers if they are non-terminals, or as data members if they are terminals.
